	...
	function Column(name) {
		...
		function createColumn() {
			...
			var $column = $('<div>').addClass('column panel panel-default'),
				...
				$columnDelete = $('<button>').addClass('btn-delete-column btn btn-sm btn-default').text('x'),
				$columnAddCard = $('<button>').addClass('add-card btn btn-sm btn-info').text('new challenge');
	...
	function Card(description) {
		...
		function createCard() {
			var $card = $('<li>').addClass('card list-group-item'),
				...
				$cardDelete = $('<button>').addClass('btn-delete btn btn-xs btn-default pull-right').text('x');
